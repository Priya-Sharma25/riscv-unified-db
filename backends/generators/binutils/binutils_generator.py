...
def _generator_comment() -> str:
    # Avoid embedding full invocation paths/arguments in generated artifacts.
    return "binutils_generator.py"
...
def generate_binutils_opcodes(
    ...
    generator_comment = _generator_comment()

    opcode_entries = []
    constants = []
    custom_classes = set()
    custom_class_extensions = {}
    stats = {
        "total": 0,
        "success": 0,
    ...
    for name, info in sorted(instr_dict.items(), key=lambda x: x[0].upper()):
        ...
        try:
            ...
            if (
                ...
                custom_class_extensions[insn_class] = defined_by
            stats["success"] += 1
        except Exception as e:
            stats["errors"] += 1
    ...
    prelude = f"/* Code generated by {generator_comment}; DO NOT EDIT. */\n"
    prelude += (
...
"""
    ...
    generate_header_file(output_file, generator_comment, constants, custom_classes)
    generate_subset_support(output_file, generator_comment, custom_class_extensions)
...
def generate_header_file(output_file, generator_comment, constants, custom_classes):
    if not constants:
        logging.warning("No constants collected for header generation")
        return
    header_file = output_file.replace(".c", ".h")
    header_content = f"""/* Code generated by {generator_comment}; DO NOT EDIT. */
/* This file should be placed at: binutils-gdb/include/opcode/riscv.h (append to existing file) */

#ifndef RISCV_OPC_H
#define RISCV_OPC_H

/* RISC-V opcode constants for {len(constants)} instructions */
...
"""
    ...
    stats_msg = f"  MATCH/MASK constants: {len(constants) * 2}"
    if custom_classes:
...
def generate_subset_support(output_file, generator_comment, custom_class_extensions):
    if not custom_class_extensions:
        return
    support_file = "elfxx-riscv.c"
    content = f"""/* Code generated by {generator_comment}; DO NOT EDIT. */
